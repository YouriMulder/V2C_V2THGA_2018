...
void ViewManager::createScreenBorders() {
	...
	case 2:
		...
		mBorders[1].setPosition(sf::Vector2f(0,static_cast<float>(mMainWindow.getSize().y/2)) + sf::Vector2f(2,2));
	...
	case 4:
		...
		mBorders[0].setFillColor(sf::Color::Transparent);
		mBorders[1] = sf::RectangleShape(mScreens[1].view.getSize() - sf::Vector2f(4, 4));
		mBorders[1].setPosition(sf::Vector2f(static_cast<float>(mMainWindow.getSize().x/2),0)+ sf::Vector2f(2, 2));
		mBorders[1].setOutlineThickness(2);
		mBorders[1].setFillColor(sf::Color::Transparent);
		mBorders[2] = sf::RectangleShape(mScreens[2].view.getSize() - sf::Vector2f(4, 4));
		mBorders[2].setPosition(sf::Vector2f(0, static_cast<float>(mMainWindow.getSize().y/2)) + sf::Vector2f(2, 2));
		mBorders[2].setOutlineThickness(2);
		mBorders[2].setFillColor(sf::Color::Transparent);
		mBorders[3] = sf::RectangleShape(mScreens[3].view.getSize() - sf::Vector2f(4, 4));
		mBorders[3].setPosition(sf::Vector2f(static_cast<float>(mMainWindow.getSize().x / 2),static_cast<float>( mMainWindow.getSize().y / 2)) + sf::Vector2f(2, 2));
